...
<?php
		...
		{
			header("Location: http://localhost/OnlineShopping/admin/index.php");
		}*/
		include 'includes/left-bar.php';
?>
	<div class="col-md-10" style="background: url('images/admin1.jpg') no-repeat;background-size: 100%;min-height:570px;">
